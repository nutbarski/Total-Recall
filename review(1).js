...
let Sabrina = "Sabrina";
let letter_i = Sabrina.charAt(4);
console.log(letter_i);

// Define Unicode in a comment, and get the Unicode using charCodeAt() of the third character in Teddy

//Unicode is a universal text standard where each character has a numeric value!
let Teddy = "Teddy";
let thirdChar = Teddy.charCodeAt(2);
console.log(thirdChar); // Output will be the Unicode value of 'd' in "Teddy"

// Using fromCharCode() to convert the Unicode value back to its corresponding character
let readableVar = String.fromCharCode(thirdChar);
console.log(readableVar);
...
console.log(stringVar.startsWith("Str"));
